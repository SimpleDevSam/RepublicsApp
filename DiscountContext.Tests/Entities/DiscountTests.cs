...
namespace DiscountContext.Test.Entities
{
    ...
    public class DiscountTests
    {
        ...
        public void ShouldReturnErrorWhenStudentIsInvalid()
        {
            ...
            var student = new Student(new Name("", "LastName"), new BirthDate(DateTime.Now.AddYears(-20)), "samuca123", "samuekl@gmail.com", "samuelufop12");
        ...
        {
            var student = new Student(new Name("FirstName", "LastName"), new BirthDate(DateTime.Now.AddYears(-20)), "samuca123", "samuekl@gmail.com", "samuelufop12"); 
            var expireDate = DateTime.Now.AddDays(10);
